...
public class Bar {
    ...
    double pos;
    public double transferpos = 0.818;
    public double wallpos = 0.864;
    public double bucketpos = 0.262;
    public double clip2 = 0.403;
    public double clip1 = 0.403;
    public double neutralpos = 0.723;
